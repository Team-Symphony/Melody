...
public class MapBookEmptyProperty implements BooleanProperty {

    public static final MapCodec<MapBookEmptyProperty> CODEC = MapCodec.unit(new MapBookEmptyProperty());
    ...
    @Override
    public MapCodec<MapBookEmptyProperty> getCodec() {
        return CODEC;
    }
