...
public final class RecipeRegistry {
    ...
    private static final MapBookAdditionRecipe MAP_BOOK_ADDITION_SERIALIZER$lambda$0(CraftingRecipeCategory craftingRecipeCategory) {
        return new MapBookAdditionRecipe(craftingRecipeCategory);
    }

    private static final MapBookCloningRecipe MAP_BOOK_CLONING_SERIALIZER$lambda$1(CraftingRecipeCategory craftingRecipeCategory) {
