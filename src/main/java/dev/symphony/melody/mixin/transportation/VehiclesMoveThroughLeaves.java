...
public class VehiclesMoveThroughLeaves extends Block {
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        if (MelodyConfig.vehiclesMoveThroughLeaves && context instanceof EntityShapeContext entityContext) {
    ...
    public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
        if (MelodyConfig.vehiclesMoveThroughLeaves && entity.hasControllingPassenger())
            entity.slowMovement(state, new Vec3d(MelodyConfig.leafSpeedFactor, 1, MelodyConfig.leafSpeedFactor));
    }
}
